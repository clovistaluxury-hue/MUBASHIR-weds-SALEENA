        ...
        <svg class="wedding-butterfly" viewBox="0 0 100 100">
            <defs>
                <linearGradient id="bfly-grad" x1="0%" y1="0%" x2="100%" y2="100%">
                    ...
                    <stop offset="50%" stop-color="#F2DFB8" />
                    <stop offset="100%" stop-color="#D4B076" />
                </linearGradient>
            </defs>
            <!-- Left Wing -->
            <g class="bfly-wing bfly-wing-left">
                <path d="M 50 45 C 30 20, 5 15, 5 40 C 0 60, 20 70, 35 60 C 25 80, 35 95, 48 85 Z" fill="url(#bfly-grad)" opacity="0.9" stroke="#E4C98A" stroke-width="1.5"/>
            </g>
            <!-- Right Wing -->
            <g class="bfly-wing bfly-wing-right">
                <path d="M 50 45 C 70 20, 95 15, 95 40 C 100 60, 80 70, 65 60 C 75 80, 65 95, 52 85 Z" fill="url(#bfly-grad)" opacity="0.9" stroke="#E4C98A" stroke-width="1.5"/>
            </g>
            <!-- Body -->
